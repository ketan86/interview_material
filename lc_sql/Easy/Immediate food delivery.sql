...
-- orders at some date and specify a preferred delivery date 
...
SELECT ROUND(t1.same_day_orders/t2.total_orders * 100, 2) as immediate_percentage
FROM (
    SELECT COUNT(*) as same_day_orders
    FROM Delivery
...
-- Total orders count in round function directly
SELECT ROUND(
    COUNT(delivery_id)
    /
    (
