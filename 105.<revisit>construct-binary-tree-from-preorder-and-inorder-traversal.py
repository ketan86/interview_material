...
class Solution:
    ...
    def buildTree(self, preorder, inorder):
        ...
        return self.build_efficient(
            preorder, inorder, in_start=0, in_end=len(preorder) - 1)
    ...
    def build_efficient(self, preorder, inorder, in_start, in_end):
        # if start is greater than end node, there is no left or right node.
        # return None.
        if in_start > in_end:
            return None
