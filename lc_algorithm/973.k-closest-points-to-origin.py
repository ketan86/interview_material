...
class Solution:
    def kClosest(self, points, K):
        """
        Runtime: 664 ms, faster than 67.17%
        ...
        1. by doing x*x, you are able to consider coordinates that are
           negative.
        2. by doing x*x + y*y, we are calculating the distance of the
           coordinate from the center. the sum of both distance will
           decide which coordinates are closer.
                     |
                    !|   *
                    !|______
                     -----
