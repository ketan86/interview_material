...
class Solution:
    def minRemoveToMakeValid(self, s):
        """
        Runtime: 464 ms, faster than 10.61%

        Steps:
        1. Use stack to find all parenthese that need to be
           removed.
        2. Store the parentheses and index of that parenthese.
        3. Iterate over the string in reversed (stack values are popped
           in reversed ordered) and when index of the parenthese is found,
