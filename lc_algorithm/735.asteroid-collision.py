...
class Solution:
    def asteroidCollision(self, asteroids):
        """Runtime: 92 ms, faster than 87.57%"""
        stack = []
        ...
        for asteroid in asteroids:
            ...
            while stack and stack[-1] > 0 and asteroid < 0:
                # three possibilities
                # 1: prev asteroid is smaller than curr (prev explodes)
            ...
            # NOTE: in `while else`, else is called if loop condition
            # un-satisfies but not by break.
